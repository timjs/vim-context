...
"   c = capitalized blackboard shortcuts
"   a = accents
" By default we conceal all math except a, c and S.
" inside braces.
...
if has('folding')
  if exists('g:context_fold')
    let s:context_fold = g:context_fold
  else
...
" Super And Subscript Inside Braces: {{{2
